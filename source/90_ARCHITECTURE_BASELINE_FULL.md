> **STATUS: DESIGN REFERENCE.** This full specification is subordinate to `00_PROJECT_CONSTITUTION.md`, `01_CANONICAL_FACTS.md`, and `02_CANONICAL_DECISIONS.md` if any conflict appears. It does not prove current implementation state.
